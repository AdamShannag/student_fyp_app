<x-app-layout>
    ...
    <div class="p-5">
        ...
        <div class="block p-6 rounded-lg shadow-lg bg-white ">
            <h5 class="text-gray-900 text-xl leading-tight font-medium mb-4">{{ $student->first_name }} {{ $student->last_name }}</h5>
            <hr>
            ...
            ease-in-out"
                ...
                duration-150
                ease-in-out">Edit</a>
                <form class="inline-block" action="{{route('student.destroy',$student->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
                <button type="submit"
